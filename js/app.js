...
// ?ARTICLE5
const article5 = {
  title: "Alcohol-based sanitizers are safe for everyone to use",
  imgSrc: "./images/news/news5v2.jpg",
  datePub: "April 12, 2022 &middot; 2 min read",
  shortDesc: "Alcohols in the sanitizers have not been shown to create any relevant health issues.",
  category: categories.news,
};
...
function newsPage1() {
  ...
  itemAuthor1 = JSON.stringify(sanPedro);
  itemAuthor1 = JSON.stringify(sanPedro, null, 4);
  console.log(item1);
  ...
  document.getElementsByClassName("author-1")[0].innerHTML = sanPedro.name;
  document.getElementsByClassName("author-profile-1")[0].src = sanPedro.profilePic;
...
function newsPage2() {
  ...
  document.getElementsByClassName("author-5")[0].innerHTML = cayari.name;
  document.getElementsByClassName("author-profile-5")[0].src = cayari.profilePic;
...
function newsLoad5() {
  ...
  itemAuthor1 = JSON.stringify(cayari);
  itemAuthor1 = JSON.stringify(cayari, null, 4);
  console.log(item1);
  console.log(itemAuthor1);
  //-
  document.getElementsByClassName("news-title-5")[0].innerHTML = article5.title;
...
function aboutLoad() {
  ...
  document.getElementsByClassName("madam-profile-1")[0].href = madam.profilePic1;
